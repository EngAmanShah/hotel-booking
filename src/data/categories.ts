  ...
  return [
    {
      ...
      thumbnail: 'https://images.pexels.com/photos/2830507/pexels-photo-2830507.jpeg',
      coverImage: {
    ...
    },
    {
      ...
      region: 'Medina',
      handle: 'Medina',
      href: '/stay-categories/Medina',
      count: 2500,

      thumbnail: 'https://images.pexels.com/photos/1064766/pexels-photo-1064766.jpeg',
      coverImage: {
        src: stayCategoryCoverImage.src,
        width: stayCategoryCoverImage.width,
        height: stayCategoryCoverImage.height,
    ...
    },
    {
      ...
      count: 3000,
      thumbnail: 'https://images.pexels.com/photos/5004002/pexels-photo-5004002.jpeg',
      coverImage: {
        src: stayCategoryCoverImage.src,
        width: stayCategoryCoverImage.width,
        height: stayCategoryCoverImage.height,
    ...
    },
    {
      ...
      count: 116288,
      thumbnail: 'https://images.pexels.com/photos/25839610/pexels-photo-25839610.jpeg',
      coverImage: {
        src: stayCategoryCoverImage.src,
        width: stayCategoryCoverImage.width,
        height: stayCategoryCoverImage.height,
    ...
    },
    {
      ...
      count: 5000,
      thumbnail: 'https://images.pexels.com/photos/4614473/pexels-photo-4614473.jpeg',
      coverImage: {
        src: stayCategoryCoverImage.src,
        width: stayCategoryCoverImage.width,
        height: stayCategoryCoverImage.height,
    ...
    },
    {
      ...
      count: 7500,
      thumbnail: 'https://images.pexels.com/photos/33174803/pexels-photo-33174803.jpeg',
      coverImage: {
        src: stayCategoryCoverImage.src,
        width: stayCategoryCoverImage.width,
        height: stayCategoryCoverImage.height,
    ...
    },
    {
      ...
      count: 8100,
      thumbnail: 'https://images.pexels.com/photos/15729073/pexels-photo-15729073.jpeg',
      coverImage: {
        src: stayCategoryCoverImage.src,
        width: stayCategoryCoverImage.width,
        height: stayCategoryCoverImage.height,
...
export async function getStayCategoryByHandle(handle?: string) {
  ...
  if (!handle || handle === 'all') {
    return {
      id: 'stay://all',
      name: locale === 'en' ? 'Explore stays' : ' استكشف الإقامات',
      handle: 'all',
      href: '/stay-categories/all',
      region: locale ==='en'? 'Worldwide' : "حول العالم",
      count: 144000,
      description: locale === 'en'? 'Explore all stays around the world' : 'استكشف جميع الإقامات حول العالم',
      thumbnail:
  ...
  return [
    {
      ...
      count: 1500,
      thumbnail: 'https://www.bedinroom.com/_next/image/?url=%2Fimages%2Friadh.jpeg&w=1920&q=75',
      coverImage: {
